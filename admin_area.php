	...
	<div class="row">
		...
		<div class="col-sm-9" >
			...
			<div class="row">
				...
				{
				 $sql="INSERT INTO area(CITY_ID,STATE_ID,AREA_NAME) VALUES ('".$_POST["cityname"]."','".$_POST["statename"]."','".$_POST["areaname"]."')";
					$con->query($sql);
				...
				?>
					...
					<div class="form-group text-primary">
						...
						<div class="form-group text-primary">
							...
							<select name="statename" id="CITY" required class="form-control">
